...
export function ClientComanda({
  ...
  const editable = !comanda.service_started_at && EDITAVEL.includes(comanda.status);
            ...
            <div key={it.id} className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                {editable && !it.covered_by_plan && (
                  <button
                    onClick={() => run(() => removeComandaItemClient(it.id))}
                    aria-label="Remover"
            ...
            <div className="flex flex-wrap gap-2">
              {services.map((s) => (
                <button
                  ...
                  onClick={() =>
                    run(() =>
                      addComandaItemClient(comanda.id, {
                        kind: "service",
                        refId: s.id,
                        name: s.name,
